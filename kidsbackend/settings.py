...
# NB: to make the browsable API work you need rest_framework.authentication.SessionAuthentication activated
# But doesn't work if you're also running a token, so only for debugging
REST_FRAMEWORK = {
